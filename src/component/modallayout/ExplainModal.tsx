      ...
      {modalGather.explainModal && (
        <ModalBackground onClick={() => setmodalGather({ ...modalGather, explainModal: false })}>
          ...
          >
            ...
            <ExplainYellowWrap margin="0">
              ...
              {makeLong1 && (
                <>
                  ...
                  <ExplainLevel levelText={`레벨업 조건`} text={`레벨당 투두 2개`} margin={`0.3125rem 0 1.25rem 0`} />
                </>
              )}
            </ExplainYellowWrap>

            {/* Step2 설명 */}
            <ExplainYellowWrap margin="0.625rem 0 0 0">
              <EvRowBox width={'18.4375rem'} height={1.25} margin="1rem 0 0 0">
                <EvFontBox width={'2.6875rem'} height={1.25} margin={'0 auto auto 1.25rem'}>
                  <EvKoreanFont size={0.875} weight={700}>
                    Step 2
            ...
            />
            <img src="/assets/table.svg" style={{ margin: '1.25rem 0' }}></img>
          </BoxWrap>
        </ModalBackground>
      )}
    </>
