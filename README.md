...
| ---------- | ------------ | ------------------------------ |  ------------------------------ |
| **심아영** | `프론트엔드` | https://github.com/ccimayoung | [부리더] 1. CICD/무중단배포 2. 로그인/회원가입/온보딩<br/> 3. 메인페이지 4. 채팅 5. 친구목록/친구페이지<br/> 6. 알림(개발중)
...
| **양희수** | `백엔드` | https://github.com/hee1su123 | 1. 채팅(WebSocket, Redis) 2. 친구추가<br/>3. To-do 리스트 4. 캐릭터 및 아이템
| **박혜진** | `디자이너` | 🚢 | 🚢 |
| **최민영** | `디자이너` | 🚢 | 🚢 |
